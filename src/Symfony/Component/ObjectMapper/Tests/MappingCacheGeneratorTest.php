...
final class MappingCacheGeneratorTest extends TestCase
{
    ...
    public function testGenerateAndWriteCacheFile(): void
    {
        ...
        $objectMapper = $this->createStub("Symfony\\Component\\ObjectMapper\\ObjectMapperInterface"::class);
    ...
    public function testServiceLocatorMappingCacheGeneration(): void
    {
        $metadataFactory = new ReflectionObjectMapperMetadataFactory();
        $generator = new MappingCacheGenerator($metadataFactory);
    ...
    public function testPromotedConstructorMappingCacheGeneration(): void
    {
        $metadataFactory = new ReflectionObjectMapperMetadataFactory();
        $generator = new MappingCacheGenerator($metadataFactory);

        $sourceClass = \Symfony\Component\ObjectMapper\Tests\Fixtures\PromotedConstructor\Source::class;
        $targetClass = \Symfony\Component\ObjectMapper\Tests\Fixtures\PromotedConstructor\Target::class;
