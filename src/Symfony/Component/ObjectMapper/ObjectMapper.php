...
{
    /**
     * @param ContainerInterface<TransformCallableInterface> $transformCallableLocator a service locator for transform callbacks
     * @param ContainerInterface<ConditionCallableInterface> $conditionCallableLocator a service locator for condition callbacks
     */
    ...
    public function map(object $source, object|string|null $target = null): object
    {
        ...
        if ($map && $map->transform) {
            ...
            if (!\is_object($mappedTarget)) {
                throw new MappingTransformException('Cannot map to a non-object.');
            }
        }
